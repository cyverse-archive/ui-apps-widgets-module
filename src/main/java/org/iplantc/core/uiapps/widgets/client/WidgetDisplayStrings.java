package org.iplantc.core.uiapps.widgets.client;

/**
 * Interface to represent the messages contained in resource bundle:
 * /de-widgets-module/src/main/resources/org/iplantc/core/widgets/client/WidgetDisplayStrings.properties'
 * .
 */
public interface WidgetDisplayStrings extends com.google.gwt.i18n.client.Messages {
  ...
  /**
   * Translated "Import request for '{'0'}' has been submitted. You will be notified when it is complete.".
   * 
   * @return translated "Import request for '{'0'}' has been submitted. You will be notified when it is complete."
   */
  @DefaultMessage("Import request for '{'0'}' has been submitted. You will be notified when it is complete.")
  @Key("importRequestSubmit")
  String importRequestSubmit();
   ...
   * 
   * @return translated "Select folder"
   */
