...
import org.iplantc.core.uiapps.widgets.client.appWizard.view.fields.converters.SplittableStringListToStringConverter;
...
public abstract class AppWizardDiskResourceSelector extends Component implements ArgumentField, LeafValueEditor<Splittable> {
    ...
    public void initialize(Argument property) {
        /* Do Nothing */
        input.addValidator(new EmptyValidator<String>());
    }
